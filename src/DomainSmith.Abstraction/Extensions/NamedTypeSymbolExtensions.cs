...
{
    public static IdMetadata GetIdMetadata(this INamedTypeSymbol idTypeSymbol)
    {
        var isRecord = false;
        var isClass = false;
    ...
    public static List<ParameterInfo> GetEntityCtorArgsFromPublicProperties(this INamedTypeSymbol idTypeSymbol)
    {
        return idTypeSymbol
            .GetMembers()
