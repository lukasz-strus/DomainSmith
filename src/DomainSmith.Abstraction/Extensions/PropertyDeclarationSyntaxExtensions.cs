...
{
    extension(PropertyDeclarationSyntax propertySyntax)
    {
        public PropertyInfo ToPropertyInfo(GeneratorSyntaxContext context)
        {
        ...
        public bool IsExcludedFromGeneration(GeneratorSyntaxContext context)
        {
            var symbol = context.SemanticModel.GetDeclaredSymbol(propertySyntax);
