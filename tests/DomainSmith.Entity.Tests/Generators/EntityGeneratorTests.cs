...
public sealed class EntityGeneratorTests
{
    ...
    [Fact]
    public async Task EntityGenerator_WithStringProperty_ShouldGenerateResultCode()
    {
        // Arrange
        var inputCompilation = CompilationCreator.CreateCompilation(InputSourceWithStringPropertyForResult);
    ...
    private const string InputSourceWithStringPropertyForResult =
        """
